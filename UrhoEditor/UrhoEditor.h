...
namespace SprueEditor
{
    ...
    class UrhoEditor : public QMainWindow
    {
        Q_OBJECT
    public:
        /// Construct the frame with the given GUI builder classes.
        UrhoEditor(Settings* settings, const std::vector<GuiBuilder*>& guiBuilders, const std::vector<DocumentHandler*>& docHandlers, QWidget *parent = 0);
        /// Destruct.
        virtual ~UrhoEditor();

        /// Returns the singleton for the main GUI.
        static UrhoEditor* GetInstance();
        ...
        Selectron* GetObjectSelectron() { return &objectSelectron_; }
    ...
    private:
        ...
        /// The selectron is used for managing the status of selections in the editor.
        Selectron objectSelectron_;
