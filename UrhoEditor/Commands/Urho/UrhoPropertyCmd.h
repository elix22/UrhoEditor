...
#define URHO_PROPERTY_UNDO(EDITING, PROPERTY, NEWVALUE) { SmartCommand* cmd = new UrhoUI::UrhoPropertyCmd(EDITING, PROPERTY, NEWVALUE, EDITING->GetObject()->GetAttribute(PROPERTY)); \
