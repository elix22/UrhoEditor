...
namespace UrhoUI
{
    ...
    void UrhoPropertyCmd::Redo()
    {
        ...
        if (!IsFirstRedo())
            SprueEditor::UrhoEditor::GetInstance()->GetObjectSelectron()->NotifyDataChangedSoft(0x0, object_);
    ...
    bool UrhoPropertyCmd::CanMergeWith(const SmartCommand* other)
    {
        ...
        {
            if (rhs->object_ == object_ && rhs->property_ == property_)
                return true;
        }
        return false;
    }
    ...
    {
        SprueEditor::UrhoEditor::GetInstance()->GetObjectSelectron()->NotifyDataChanged(0x0, object_, -1);
    }
    ...
    {
        SprueEditor::UrhoEditor::GetInstance()->GetObjectSelectron()->NotifyDataChanged(0x0, object_);
    }
